...
export function buildPhotoAnalysisPrompt(technicalContext: any = {}) {
  return `
...
- submissionAssessment.verdict 必须从以下选项中选择一个：${submissionVerdicts.join('；')}。
...
export const photoAnalysisResponseSchema = {
  type: 'object',
  properties: {
    scores: {
      type: 'object',
