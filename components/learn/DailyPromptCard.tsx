...
export const DailyPromptCard: React.FC<DailyPromptCardProps> = ({
  ...
  return (
    <div className="bg-zinc-900/50 border border-white/5 rounded-xl overflow-hidden">
      {/* Header */}
      <div className="bg-gradient-to-r from-[#D40000]/20 to-transparent px-6 py-4 border-b border-white/5">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-[#D40000] rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(212,0,0,0.3)]">
            <Sparkles size={18} />
          </div>
          <div>
            <div className="text-xs text-zinc-500 tracking-wider">TODAY'S INSPIRATION</div>
      ...
      <div className="p-6 space-y-5">
        ...
        <button
          onClick={onStartChallenge}
          className="w-full py-3 bg-[#D40000] hover:bg-[#B30000] text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2 group"
        >
          <span>开始挑战</span>
